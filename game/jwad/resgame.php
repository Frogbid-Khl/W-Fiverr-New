...
<div style="margin:auto; overflow:hidden;position:relative; padding:0px;">
   <iframe src="https://jwcasino.net/angelsdemons" width="780" height="700" scrolling="no" frameborder="0"></iframe>
    </div>
                     ...
                     <div class="po_box" id="peven">
                        <a href="javascript:check_bet('peven')">
                           <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                 <td class="td_left"><div class="po_color1">엔젤</div></td>
                                 <td class="td_right">
                  ...
                  <td width="10%" class="ps_3">
                     <div class="po_box" id="podd">
                        <a href="javascript:check_bet('podd')">
                           <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                 <td class="td_left"><div class="po_color2">데몬</div></td>
                                 <td class="td_right">
