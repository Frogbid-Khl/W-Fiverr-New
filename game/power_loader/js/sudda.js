...
function getGameInfo(t) {
    ...
    resetMoneyBet();
    $.ajax({
        url: '/game/power_loader/game_info.php',
        type: 'GET',
        dataType: 'json',
        data: {},
        success: function (data, textStatus, jqXHR) {
...
function get_bet_list(r, r1) {
    var d = new Date();
    $.ajax({
        url: '/game/power_loader/search_bet_info.php?r=' + r + '&_t=' + d.getTime() + '&game_type=4',
        type: 'GET',
        dataType: 'json',
        data: {},
        success: function (data, textStatus, jqXHR) {
    ...
    //tabs = "<a href=\"javascript:get_bet_list(" + (parseInt(r) - 1) + "," + (parseInt(r1) - 1) + ");\"><img src=\"/game/power_loader/images/cart_arrow_left.png\"></a>";
    //tabs = tabs + "<a href=\"javascript:get_bet_list(" + (parseInt(r) + 1) + "," + (parseInt(r1) + 1) + ");\"><img src=\"/game/power_loader/images/cart_arrow_right.png\"></a>";
...
function Betting() {
    ...
    $.ajax({
	url: '/game/power_loader/betting_sudda.php',
        type: 'POST',
        dataType: 'json',
        data: bet,
