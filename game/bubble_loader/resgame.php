...
<div id="contents_wrap">
    <div class="contents_box">
        <div class="contents_in">
            ...
            <div id="block" style="widht:100%; text-alight:left;">◎짱구사다리3분</div>
      ...
      <div class="bet_cart">
         <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0">
            <tr>
             ...
             <td width="10%" align="center" class="ps_3"><a href="javascript:addMoneyBet(100000)"><span class="cart_btn1">100,000원</span></a></td>
              </tr>
            <tr>
               <td width="10%" align="center" class="ps_1"><a href="javascript:addMoneyBet(300000)"><span class="cart_btn1">300,000원</span></a></td>
         ...
         <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0">
            <tr>
               <td width="10%" align="center" class="ps_1"><a href="javascript:addMoneyBetMax();"><span class="cart_btn1">MAX</span></a></td>
                <td width="10%" align="center" class="ps_1"><a href="javascript:Betting();"><span class="cart_btn1">베팅하기</span>   </a>
               </td>
