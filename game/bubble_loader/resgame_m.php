             ...
             <iframe  src="https://bepick.net/live/bubbleladder" width="1024" height="768" style="transform:scale(calc(0.35));transform-origin: left top;"  scrolling="no" frameborder="0"></iframe>
				...
				<div class="section-box">
					...
					<div class="game-select-box-cont1">
						<div class="small-tit">좌/우,3줄/4줄,홀/짝  맞추는 게임.</div>
						<div class="cont">
							<ul>
								<li onclick="check_bet('peven')" id="peven">
									<div class="game-ctrl blue-box round">
										<p>좌<span class="str_prate rate_aeven po_no">1.95</span></p>
									</div>
								</li>

								<li onclick="check_bet('podd')" id="podd">
									<div class="game-ctrl red-box round">
										<p>우<span class="str_prate rate_aodd po_no">1.95</span></p>
									</div>
								</li>
							</ul>
							<ul>
								<li onclick="check_bet('pdown')" id="pdown">
									<div class="game-ctrl blue-box round">
										<p>3줄<span class="str_prate rate_adown po_no">1.95</span></p>
									</div>
								</li>
								<li onclick="check_bet('pup')" id="pup">
									<div class="game-ctrl red-box round">
										<p>4줄<span class="str_prate rate_aup po_no">1.95</span></p>
									</div>
								</li>
							</ul>
							<ul>
								<li onclick="check_bet('aeven')" id="aeven">
									<div class="game-ctrl blue-box round">
										<p>홀<span class="str_prate rate_peven po_no">1.95</span></p>
									</div>
								</li>
								<li onclick="check_bet('aodd')" id="aodd">
									<div class="game-ctrl red-box round">
										<p>짝<span class="str_prate rate_podd po_no">1.95</span></p>
									</div>
								</li>
							</ul>
							<!-- <ul>
					...
					<div class="cart-top">
						...
						<div class="ct_betbt">
							<div>
								...
								<button  style="color:black;" class="betbt" type="button" onClick="addMoneyBet(300000)">300,000원</button>
