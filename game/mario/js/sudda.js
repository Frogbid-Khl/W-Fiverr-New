...
function check_bet(kind) {
    ...
    var choice = "";
    if (bet.kind == 'peven') {
        choice = "<div class=\"po_color1\">은</div><span style=\"color: #98a3ae; float: left\">" + bet.odds + "</span>";
        bet.value = 1;
        bet.gameType = 1;
    } else if (bet.kind == 'podd') {
        choice = "<div class=\"po_color2\">금</div><span style=\"color: #98a3ae; float: left\">" + bet.odds + "</span>";
        bet.value = 2;
        bet.gameType = 1;
