...
<div style="display: inline-block;
    ...
    padding-left: 10px;
    padding:0px;">
      <iframe src="https://jwcasino.net/supermario" id="live-iframe" scrolling="no" frameborder="0" style="
    width: 200%;
    height: 720px;
    border: 0;
    display: block;
                     ...
                     <div class="po_box" id="peven">
                        <a href="javascript:check_bet('peven')">
                           <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                 <td class="td_left"><div class="po_color1">은</div></td>
                                 <td class="td_right">
                  ...
                  <td width="10%" class="ps_3">
                     <div class="po_box" id="podd">
                        <a href="javascript:check_bet('podd')">
                           <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                 <td class="td_left"><div class="po_color2">금</div></td>
                                 <td class="td_right">
