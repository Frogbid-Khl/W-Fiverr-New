...
<div class="mbskin">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <?php } ?>
		        ...
		        <tr>
            <th scope="row"><label for="reg_mb_1">계좌번호<strong class="sound_only">필수</strong></label></th>
            <td>
                <span class="frm_info">코리아금고 123-12-123456-1 형식으로 입력하세요.</span>
                <input type="text" name="mb_1" value="<?php echo $member['mb_1'] ?>" id="reg_mb_1" <?php echo $required ?> <?php echo $readonly ?> class="frm_input <?php echo $required ?> <?php echo $readonly ?>" minlength="7" size="70" maxlength="300">
                <span id="msg_mb_1"></span>
            </td>
        </tr>
		
		<select name="mb_3" id="mb_3" required>
    <option value="">선택하세요.</option>
    <option value="기업은행"<?php echo ($member['mb_3'] == "기업은행") ? " selected" : "";?>>기업은행</option>
    <option value="국민은행"<?php echo ($member['mb_3'] == "국민은행") ? " selected" : "";?>>국민은행</option>
	<option value="농협은행"<?php echo ($member['mb_3'] == "농협은행") ? " selected" : "";?>>농협은행</option>
	<option value="우리은행"<?php echo ($member['mb_3'] == "우리은행") ? " selected" : "";?>>우리은행</option>
	<option value="대구은행"<?php echo ($member['mb_3'] == "대구은행") ? " selected" : "";?>>대구은행</option>
	<option value="제일은행"<?php echo ($member['mb_3'] == "제일은행") ? " selected" : "";?>>제일은행</option>
	<option value="부산은행"<?php echo ($member['mb_3'] == "부산은행") ? " selected" : "";?>>부산은행</option>
	<option value="신한은행"<?php echo ($member['mb_3'] == "신한은행") ? " selected" : "";?>>신한은행</option>
	<option value="새마을금고"<?php echo ($member['mb_3'] == "새마을금고") ? " selected" : "";?>>새마을금고</option>
	<option value="광주은행"<?php echo ($member['mb_3'] == "광주은행") ? " selected" : "";?>>광주은행</option>
	<option value="경남은행"<?php echo ($member['mb_3'] == "경남은행") ? " selected" : "";?>>경남은행</option>
	<option value="하나은행"<?php echo ($member['mb_3'] == "하나은행") ? " selected" : "";?>>하나은행</option>
